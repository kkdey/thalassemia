...
addpoly(res.1, row=18.5, cex=0.75, atransf=exp, mlab="RE model for Engraftment");
addpoly(res.2, row=10.5, cex=0.75, atransf=exp, mlab="RE model for DFS");
addpoly(res.3, row=1.5, cex=0.75, atransf=exp, mlab="RE model for OS");



op <-par(cex=0.75, font=4)
text(-13, c(24, 16, 7), pos=4, c("Engraftment", "Disease Free Survival","Overall Survival"), cex=0.8)
...
png(filename="/Users/kushal/Documents/thalassemia/plots/funnel_primary_effects_thalassemia.png")
