...
addpoly(res.1, row=18.5, cex=0.75, atransf=exp, mlab="RE model for aGVHD");
...
text(-13, c(24, 16.5, 8), pos=4, c("acute GVHD", "chronic GVHD","TRM"), cex=0.8)
...
png(filename="/Users/kushal/Documents/thalassemia/plots/funnel_secondary_effects_thalassemia.png")
